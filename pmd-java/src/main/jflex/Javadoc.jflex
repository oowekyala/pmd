...
<COMMENT_DATA_START, 
 COMMENT_DATA>          "{" / "@"             { yybegin(INLINE_TAG_NAME); return JavadocTokenType.INLINE_TAG_START; }
<COMMENT_DATA_START, 
...
<INLINE_TAG_NAME>       ("@code" | "@literal")      { yybegin(CODE_TAG_SPACE); braces = 0; return JavadocTokenType.TAG_NAME; }
<INLINE_TAG_NAME>       "@"{INLINE_TAG_IDENTIFIER}  { setInline(); yybegin(INLINE_TAG_SPACE); return JavadocTokenType.TAG_NAME; }
<COMMENT_DATA_START, 
 LINE_HEAD>             "@"{TAG_IDENTIFIER}         { yybegin(BLOCK_TAG_SPACE); return JavadocTokenType.TAG_NAME; }
