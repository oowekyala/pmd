 ...
 */
/*
    This file comes from https://github.com/jph98/htmlentities/blob/master/src/main/java/com/oogly/htmlentities/HTMLEnt.java
    but was modified, there was no license to be found.
 */
...
/**
 * An HTML entity, with a name and such.
 */
public enum KnownHtmlEntity {
    ...
    PI('Π', 928, "&Pi;", "Pi"),
    RHO('Ρ', 929, "&Rho;", "Rho"),
    SIGMA_FINAL('ς', 962, "&sigmaf;", "Greek Small Letter Final Sigma "),
    SMALL_SIGMA('σ', 963, "&sigma;", "Greek Small Letter Sigma"),
    ...
    KnownHtmlEntity(char character, int number, String name, String description) {
    ...
    /** Returns the name of the entity, like {@code &amp;}. */
    public String getName() {
        return name;
    }

    /** Returns the unicode code point of the entity. */
    public int getCodePoint() {
        return number;
    }

    /** Returns the unicode description. */
    ...
    /** Lookup an entity by code point. */
    @Nullable
    public static KnownHtmlEntity lookupByCode(int number) {
