...
public final class XmlUtil {
    ...
    public static Set<SchemaConstant> namesToConstants(Set<String> names) {
    ...
    public static <T> T expectElement(PmdXmlReporter err, Element elt, XmlMapper<T> syntax) {
        ...
        if (!syntax.getReadElementNames().contains(elt.getTagName())) {
            err.at(elt).warn("Wrong name, expected " + formatPossibleNames(namesToConstants(syntax.getReadElementNames())));
        } else {
