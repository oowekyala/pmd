...
public class XPathParserVisitorAdapter<T> implements XPathParserVisitor<T> {
    ...
    @Override
    public T visit(ASTForwardStep node, T data) {
         return visit((XPathNode) node, data);
    }


    @Override
    public T visit(ASTForwardAxis node, T data) {
         return visit((XPathNode) node, data);
    }


    @Override
    public T visit(ASTAbbrevForwardStep node, T data) {
         return visit((XPathNode) node, data);
    }


    @Override
    public T visit(ASTReverseStep node, T data) {
         return visit((XPathNode) node, data);
    }


    @Override
    public T visit(ASTReverseAxis node, T data) {
         return visit((XPathNode) node, data);
    }


    @Override
    public T visit(ASTAbbrevReverseStep node, T data) {
         return visit((XPathNode) node, data);
    }
